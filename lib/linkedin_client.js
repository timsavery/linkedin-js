...
console.log(req.url);
console.log('has_token = %s', has_token);
console.log('has_secret = %s', has_secret);
console.log('parsed_url: %s', JSON.stringify(parsed_url));
    // Access token
    if (has_token && has_secret) {
      ...
      , function (error, oauth_token, oauth_token_secret, additionalParameters) {
          console.log('getOAuthAccessToken callback oauth_token_secret: %s', oauth_token_secret);
          console.log('getOAuthAccessToken callback oauth_token: %s', oauth_token);
    ...
    // Request token
      ...
      CLIENT.oauth.getOAuthRequestToken({
        ...
        , scope: self.options.scope.join('+')
      }
      , function (error, oauth_token, oauth_token_secret, oauth_authorize_url, additional_parameters) {
          console.log('getOAuthRequestToken callback oauth_token_secret: %s', oauth_token_secret);
          console.log('getOAuthRequestToken callback oauth_authorize_url: %s', JSON.stringify(oauth_authorize_url));
          console.log('getOAuthRequestToken callback oauth_token: %s', oauth_token);
